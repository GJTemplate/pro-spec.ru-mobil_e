        ...
        <div class="block_sorting_count_to_page">
            <?php if ($this->config->show_sort_product) { ?>
                <span class="box_products_sorting">
                    <?php echo _JSHOP_ORDER_BY . ": " . $this->sorting ;
                    ...
                    <img src="<?php echo $this->path_image_sorting_dir ?>" alt="orderby"
    ...
    <?php if ($this->config->show_product_list_filters && $this->filter_show) { ?>
        ...
        <div class="jshop filters">
            ...
            <?php if (getDisplayPriceShop()) { ?>
				...
				<span class="box_price_from"><?php echo _JSHOP_FROM ?> <input type="text" class="inputbox"
                                                                              name="fprice_from" id="price_from"
                                                                              size="7"
                                                                              value="<?php if ($this->filters['price_from'] > 0) echo $this->filters['price_from'] ?>"/></span>
				<span class="box_price_to"><?php echo _JSHOP_TO ?> <input type="text" class="inputbox" name="fprice_to"
                                                                          id="price_to" size="7"
                                                                          value="<?php if ($this->filters['price_to'] > 0) echo $this->filters['price_to'] ?>"/></span>
            ...
            <span class="clear_filter"><a href="#"
                                          onclick="clearProductListFilter();return false;"><?php echo _JSHOP_CLEAR_FILTERS ?></a></span>
        </div>
    <?php } ?>

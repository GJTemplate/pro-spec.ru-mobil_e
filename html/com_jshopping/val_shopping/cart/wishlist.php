...
<!-- Table header -->
	...
	<thead>
		<tr>
			<th scope="col" class="width20" id="image"><span><?php echo _JSHOP_IMAGE ?></span></th>
			<th scope="col" class="width20" id="item"><span><?php echo _JSHOP_ITEM ?></span></th>  
    		<th scope="col" class="width15" id="singleprice"><span><?php echo _JSHOP_SINGLEPRICE ?></span></th>
    		<th scope="col" class="width15" id="to_cart"><span><?php echo _JSHOP_REMOVE_TO_CART ?></span></th>
			<th scope="col" class="width10" id="remove"><span><?php echo _JSHOP_REMOVE ?></span></th>			
		</tr>
	</thead>

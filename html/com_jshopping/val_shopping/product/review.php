...
<?php if ($this->allow_review){?>
    <div class="review_header"><?php echo _JSHOP_REVIEWS_O?><?php print $this->product->name?><?php if ($this->config->show_product_code){?> <span class="jshop_code_prod">(<?php echo _JSHOP_EAN?>: <span id="product_code"><?php print $this->product->getEan();?></span>)</span><?php }?></div>
    ...
    <?php if ($this->allow_review > 0){?>
        ...
        <div style="float: right; display:none;  margin: 0 50px;">
<a href="https://clck.yandex.ru/redir/dtype=stred/pid=47/cid=2508/*https://market.yandex.ru/shop/186003/reviews"><img src="https://clck.yandex.ru/redir/dtype=stred/pid=47/cid=2507/*https://grade.market.yandex.ru/?id=186003&action=image&size=3" border="0" width="200" height="125" alt="Читайте отзывы покупателей и оценивайте качество магазина на Яндекс.Маркете" /></a>		</div>
		<div id="jshop_review_write" >
			...
			<div style="width: 100%; height: 60px;">
            	<label style="width: 180px; float: left;">

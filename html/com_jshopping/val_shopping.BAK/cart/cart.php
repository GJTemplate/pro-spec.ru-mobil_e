...
?>
<div class="jshop">
<form action="<?php print SEFLink('index.php?option=com_jshopping&controller=cart&task=refresh')?>" method="post" class="my-cart" name="updateCart">
...
<?php }else{?>
 <div id = "checkout"><a href = "<?php print $this->href_shop ?>">

...
<head>
    ...
    <link rel="stylesheet"
          href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/css/blueprint/screen.css"
          type="text/css" media="screen, projection"/>

    <!--<link rel="stylesheet" href="--><?php //echo $this->baseurl ?><!--/templates/-->
    <?php //echo $this->template ?><!--/css/blueprint/print.css" type="text/css" media="print" />-->

    <!--[if lt IE 8]>
    <link rel="stylesheet" href="blueprint/ie.css" type="text/css" media="screen, projection"><![endif]-->
    <link rel="stylesheet"
          href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/css/blueprint/plugins/fancy-type/screen.css"
          type="text/css" media="screen, projection"/>
    <link rel="stylesheet"
          href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/css/blueprint/plugins/joomla-nav/screen.css"
...
<noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TS4LFLL"
...
<div id="content">
    <div id="elektro_top">
        ...
        <div id="header_elektro">
            <div class="container">
                ...
                <!--			<div class="joomla-header span-16 append-1"></div>-->
        ...
        <div class="elektro-center_top">
            <div style="">
                <jdoc:include type="modules" name="mainbody_center" style="xhtml"/>
            </div>
            <div style="">
                <jdoc:include type="modules" name="elektro-center_top" style="none"/>
            </div>
            <div style="">
                <jdoc:include type="modules" name="elektro-center_top2" style="none"/>
            </div>
        </div>
    </div>
    <div style=" margin: 0px auto;">
        <?php if ($this->countModules('elektro-banner_center_left') or $this->countModules('elektro-banner_center_right') or $this->countModules('elektro-banner_center_center')) : ?>
            <div class="banner_center_my">
                <div class="elektro-banner_center_left">
                    <jdoc:include type="modules" name="elektro-banner_center_left" style="none"/>
                </div>
                <div class="elektro-banner_center_right">
                    <jdoc:include type="modules" name="elektro-banner_center_right" style="none"/>
                </div>
                <div class="elektro-banner_center_center">
                    <jdoc:include type="modules" name="elektro-banner_center_center" style="none"/>
                </div>
            </div>
        <?php endif; ?>
    </div>
    ...
    <div id="content-elektro" class="">
        ...
        if ($this->countModules(implode(' or ', $positionArr))) : ?>
            <div class="elektro-center_boss">
                ...
                <div class="tab-content">
                    <div class="title-tab-content"><a
                                href="/catalog/sredstva-i-sistemy-bezopasnosti/introskopy-rentgenotelevizionnoe-oborudovanie">Интроскопы</a>
                    </div>
                    <div style="">
                        <jdoc:include type="modules" name="mainbody_center2" style="none"/>
                    </div>
                    <div style="clear: both; width: 100%; height: 1px; margin: 0px;"></div>
                    <div class="bottom-tab-content">
                        <jdoc:include type="modules" name="mainbody_center2-2" style="none"/>
                    </div>
                </div>

                <div class="tab-content">
                    <div class="title-tab-content"><a href="/catalog/sistemy-videonabliudeniia/ip-videonablyudenie">Системы
                            видеонаблюдения</a></div>
                    <div style="">
                        <jdoc:include type="modules" name="mainbody_center3" style="none"/>
                    </div>
                    <div style="clear: both; width: 100%; height: 1px; margin: 0px;"></div>
                    <div class="bottom-tab-content">
                        <jdoc:include type="modules" name="mainbody_center3-3" style="none"/>
                    </div>
                </div>

                <div class="tab-content" style="margin-right: 0px ! important;">
                    <div class="title-tab-content"><a
                                href="/catalog/sredstva-i-sistemy-bezopasnosti/tekhnicheskie-sredstva-zashchity-informatsii">Защита
                            информации</a></div>
                    <div style="">
                        <jdoc:include type="modules" name="mainbody_center4" style="none"/>
                    </div>
                    <div style="clear: both; width: 100%; height: 1px; margin: 0px;"></div>
                    <div class="bottom-tab-content">
                        <jdoc:include type="modules" name="mainbody_center4-4" style="none"/>
                    </div>
                </div>
            </div>
            <div style="clear: both; width: 100%; height: 1px; margin: 0px;"></div>
        ...
        <div id="elektro_center">
            ...
            <?php if ($this->countModules('elektro-center_bottom_m') or $this->countModules('elektro-center_bottom_m1')
                ...
                <div class="elektro-center_bottom_m_old">
                    <div class="elektro-center_bottom_m"
                         <?php if ($this->countModules('elektro-center_bottom_m1')) : ?>style="width:60%;"<?php endif; ?> >
                        <jdoc:include type="modules" name="elektro-center_bottom_m" style="xhtml"/>
                    </div>
                    <div class="elektro-center_bottom_m1">
                        <jdoc:include type="modules" name="elektro-center_bottom_m1" style="xhtml"/>
                    </div>
                    <div class="elektro-center_bottom_m2">
                        <jdoc:include type="modules" name="elektro-center_bottom_m2" style="xhtml"/>
                    </div>
                    <div class="elektro-center_bottom_m3">
                        <jdoc:include type="modules" name="elektro-center_bottom_m3" style="xhtml"/>
                    </div>
                    <div style="clear: both;  height: 1px; margin: 0px;"></div>
                </div>
            <?php endif; ?>
        ...
        <div class="joomla-footer">
            <?php if ($this->countModules('elektro-footer') or $this->countModules('elektro-footer1') or $this->countModules('elektro-footer2')
                ...
                <div class="elektro-footer-box">
                    <div class="elektro-footer">
                        <jdoc:include type="modules" name="elektro-footer" style="elektro-footer"/>
                    </div>
                    <div class="elektro-footer1">
                        <jdoc:include type="modules" name="elektro-footer1" style="elektro-footer"/>
                    </div>
                    <div class="elektro-footer2">
                        <jdoc:include type="modules" name="elektro-footer2" style="elektro-footer"/>
                    </div>
                    <div class="elektro-footer3">
                        <jdoc:include type="modules" name="elektro-footer3" style="elektro-footer"/>
                    </div>
                    <div style="clear: both;  height: 1px; margin: 0px;"></div>
                </div>
                <div style="clear: both;  height: 1px; margin: 0px;"></div>
    ...
    <div id="elektro_bottom">
        ...
        <div style="padding: 0px 0px 40px;">
            <jdoc:include type="modules" name="footer_phone_m"
                          style="<?php echo $this->module_styles['footer_phone_m']; ?>"/>
        </div>
        <div style="clear: both;  height: 1px; margin: 0px;"></div>
        <div id="footer_fixet">
            <div id="footer_fixet2"><a style="color:#ccc;  text-decoration:none;" href="?device=desktop"
                                       data-ajax="false" rel="nofollow">полная версия сайта</a></div>
        </div>
    </div>
...
<noscript>
    <div><img src="https://mc.yandex.ru/watch/23630017" style="position:absolute; left:-9999px;" alt=""/></div>
</noscript>
<!-- /Yandex.Metrika counter -->
</body>
</html>